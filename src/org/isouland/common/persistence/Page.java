...
public class Page<T> {
	...
	private String pagination = ""; // 分页字符串
...
//		sb.insert(0,"<div class=\"page\">\n").append("</div>\n");
	...
	public void setCount(long count) {
		...
		// 拼接分页SQL，先获取总数，再计算分页
		this.pagination = " limit "+this.getFirstResult()+","+this.getMaxResults();
	}
	...
	public void setPagination(String paginationStr) {
		this.pagination = paginationStr;
	}
